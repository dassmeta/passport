...
@Results({ @org.apache.struts2.convention.annotation.Result(name = "reload", type = "redirect", location = "user-report!list.action"),
		@org.apache.struts2.convention.annotation.Result(name = "userlist", type = "redirect", location = "user-report!userList.action") })
public class UserReportAction {
	...
	public String roleEdit() throws Exception {
		this.auditedUser = ((UserDetail) this.baseService.getByUnique(UserDetail.class, "userId", this.auditedUser.getUserId()));
		List<Map<String, String>> m = (List) Struts2Utils.getSession().getAttribute("userSystemList");
		RUserInfo u = (RUserInfo) Struts2Utils.getSession().getAttribute("SSH_ONLINE_USER");
		String[] us = this.applicationService.getUserSystem(m, u.getLoginId());
		String sys = "";
