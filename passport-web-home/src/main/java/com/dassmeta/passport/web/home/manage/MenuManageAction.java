...
public class MenuManageAction extends CRUDActionSupport<AppMenu> {
	...
	public String cheakMenu() {
		...
		if ("".equals(this.id)) {
			...
			if (permissionKey.equals(permissionValue)) {
				...
				UrpPermission permissionc = (UrpPermission) this.baseService.getByUnique(UrpPermission.class, "permissionKey", permissionKey);
				if (permissionc != null) {
					bool = "true";
				}
			}
	...
	public String save() throws Exception {
		...
		if ((this.id == null) || ("".equals(this.id))) {
			...
			UrpPermission perm = (UrpPermission) this.baseService.getByUnique(UrpPermission.class, "permissionKey", menua.getPermissionKey());
			if (perm != null) {
				perm.setDescription(this.menu.getDescription() + "(������)");
				perm.setModifyTime(now);
				perm.setName(this.menu.getMenuName() + "(������)");
