...
public abstract interface AuthConstants {
	...
	public static final String LOGIN_ON_URL_KEY = "login_url";
	public static final String LOGIN_ON_URL = "/passport_security_login_on";
	public static final String AUTH_URL_LOGOUT_KEY = "logout_url";
	...
	public static final String PARAMS_LOGIN__ID_KEY = "loginid";
	public static final String PARAMS_PASSWORD = "passport_security_params_password";
	public static final String PARAMS_PASSWORD_KEY = "password";
	public static final String PARAMS_CAPTCHA = "passport_security_params_captcha";
	public static final String PARAMS_CAPTCHA_KEY = "captcha";
